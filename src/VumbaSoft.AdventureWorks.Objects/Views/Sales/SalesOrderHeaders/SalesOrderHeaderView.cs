...
{
    public class SalesOrderHeaderView : BaseView
    {
        ...
        public String ShipToAddressTitle { get; set; }
        public String ShipMethodTitle { get; set; }
        public String? CreditCardTitle { get; set; }
        public String? CurrencyRateTitle { get; set; }
