...
{
    public class ContactsControllerTests : ControllerTests
    {
        ...
        public ContactsControllerTests()
        {
            ...
            controller = Substitute.ForPartsOf<ContactsController>(validator, service);
        ...
        {
            service.Get<ContactView>(contact.Id).Returns(contact);
