...
{
    public class EmployeeAddressesControllerTests : ControllerTests
    {
        private EmployeeAddressesController controller;
        private IEmployeeAddressValidator validator;
        private IEmployeeAddressService service;
        private EmployeeAddressView address;

        public EmployeeAddressesControllerTests()
        {
            validator = Substitute.For<IEmployeeAddressValidator>();
            service = Substitute.For<IEmployeeAddressService>();

            address = ObjectsFactory.CreateEmployeeAddressView();

            controller = Substitute.ForPartsOf<EmployeeAddressesController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<EmployeeAddressView>().AsQueryable());
        ...
        {
            service.Get<EmployeeAddressView>(address.Id).Returns(address);
