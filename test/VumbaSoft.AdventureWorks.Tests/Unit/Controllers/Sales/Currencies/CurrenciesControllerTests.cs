...
{
    public class CurrenciesControllerTests : ControllerTests
    {
        private CurrenciesController controller;
        private ICurrencyValidator validator;
        private ICurrencyService service;
        private CurrencyView currency;

        public CurrenciesControllerTests()
        {
            validator = Substitute.For<ICurrencyValidator>();
            service = Substitute.For<ICurrencyService>();

            currency = ObjectsFactory.CreateCurrencyView();

            controller = Substitute.ForPartsOf<CurrenciesController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<CurrencyView>().AsQueryable());
        ...
        {
            service.Get<CurrencyView>(currency.Id).Returns(currency);
