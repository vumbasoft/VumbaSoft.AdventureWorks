...
{
    public class SalesTerritoryHistoriesControllerTests : ControllerTests
    {
        private SalesTerritoryHistoriesController controller;
        private ISalesTerritoryHistoryValidator validator;
        private ISalesTerritoryHistoryService service;
        private SalesTerritoryHistoryView history;

        public SalesTerritoryHistoriesControllerTests()
        {
            validator = Substitute.For<ISalesTerritoryHistoryValidator>();
            service = Substitute.For<ISalesTerritoryHistoryService>();

            history = ObjectsFactory.CreateSalesTerritoryHistoryView();

            controller = Substitute.ForPartsOf<SalesTerritoryHistoriesController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<SalesTerritoryHistoryView>().AsQueryable());
        ...
        {
            service.Get<SalesTerritoryHistoryView>(history.Id).Returns(history);
