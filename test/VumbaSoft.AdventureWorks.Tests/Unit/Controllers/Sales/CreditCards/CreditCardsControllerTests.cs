...
{
    public class CreditCardsControllerTests : ControllerTests
    {
        ...
        {
            validator = Substitute.For<ICreditCardValidator>();
            service = Substitute.For<ICreditCardService>();

            card = ObjectsFactory.CreateCreditCardView();

            controller = Substitute.ForPartsOf<CreditCardsController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<CreditCardView>().AsQueryable());
        ...
        {
            service.Get<CreditCardView>(card.Id).Returns(card);
