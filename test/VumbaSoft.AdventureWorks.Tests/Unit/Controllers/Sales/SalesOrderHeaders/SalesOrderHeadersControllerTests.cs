...
{
    public class SalesOrderHeadersControllerTests : ControllerTests
    {
        private SalesOrderHeadersController controller;
        private ISalesOrderHeaderValidator validator;
        private ISalesOrderHeaderService service;
        private SalesOrderHeaderView header;

        public SalesOrderHeadersControllerTests()
        {
            validator = Substitute.For<ISalesOrderHeaderValidator>();
            service = Substitute.For<ISalesOrderHeaderService>();

            header = ObjectsFactory.CreateSalesOrderHeaderView();

            controller = Substitute.ForPartsOf<SalesOrderHeadersController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<SalesOrderHeaderView>().AsQueryable());
        ...
        {
            service.Get<SalesOrderHeaderView>(header.Id).Returns(header);
