...
{
    public class SalesOrderHeaderSalesReasonsControllerTests : ControllerTests
    {
        private SalesOrderHeaderSalesReasonsController controller;
        private ISalesOrderHeaderSalesReasonValidator validator;
        private ISalesOrderHeaderSalesReasonService service;
        private SalesOrderHeaderSalesReasonView reason;

        public SalesOrderHeaderSalesReasonsControllerTests()
        {
            validator = Substitute.For<ISalesOrderHeaderSalesReasonValidator>();
            service = Substitute.For<ISalesOrderHeaderSalesReasonService>();

            reason = ObjectsFactory.CreateSalesOrderHeaderSalesReasonView();

            controller = Substitute.ForPartsOf<SalesOrderHeaderSalesReasonsController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<SalesOrderHeaderSalesReasonView>().AsQueryable());
        ...
        {
            service.Get<SalesOrderHeaderSalesReasonView>(reason.Id).Returns(reason);
