...
{
    public class ProductCostHistoriesControllerTests : ControllerTests
    {
        private ProductCostHistoriesController controller;
        private IProductCostHistoryValidator validator;
        private IProductCostHistoryService service;
        private ProductCostHistoryView history;

        public ProductCostHistoriesControllerTests()
        {
            validator = Substitute.For<IProductCostHistoryValidator>();
            service = Substitute.For<IProductCostHistoryService>();

            history = ObjectsFactory.CreateProductCostHistoryView();

            controller = Substitute.ForPartsOf<ProductCostHistoriesController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<ProductCostHistoryView>().AsQueryable());
        ...
        {
            service.Get<ProductCostHistoryView>(history.Id).Returns(history);
