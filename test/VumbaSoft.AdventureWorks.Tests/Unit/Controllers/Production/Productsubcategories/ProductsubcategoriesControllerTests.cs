...
{
    public class ProductsubcategoriesControllerTests : ControllerTests
    {
        private ProductsubcategoriesController controller;
        ...
        public ProductsubcategoriesControllerTests()
        {
            ...
            controller = Substitute.ForPartsOf<ProductsubcategoriesController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<ProductView>().AsQueryable());
