...
{
    public class ProductListPriceHistoriesControllerTests : ControllerTests
    {
        private ProductListPriceHistoriesController controller;
        private IProductListPriceHistoryValidator validator;
        private IProductListPriceHistoryService service;
        private ProductListPriceHistoryView history;

        public ProductListPriceHistoriesControllerTests()
        {
            validator = Substitute.For<IProductListPriceHistoryValidator>();
            service = Substitute.For<IProductListPriceHistoryService>();

            history = ObjectsFactory.CreateProductListPriceHistoryView();

            controller = Substitute.ForPartsOf<ProductListPriceHistoriesController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<ProductListPriceHistoryView>().AsQueryable());
        ...
        {
            service.Get<ProductListPriceHistoryView>(history.Id).Returns(history);
