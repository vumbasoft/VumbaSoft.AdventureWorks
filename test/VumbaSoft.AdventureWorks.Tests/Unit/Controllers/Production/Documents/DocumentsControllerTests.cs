...
{
    public class DocumentsControllerTests : ControllerTests
    {
        ...
        {
            validator = Substitute.For<IDocumentValidator>();
            service = Substitute.For<IDocumentService>();

            document = ObjectsFactory.CreateDocumentView();

            controller = Substitute.ForPartsOf<DocumentsController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<DocumentView>().AsQueryable());
        ...
        {
            service.Get<DocumentView>(document.Id).Returns(document);
