...
{
    public class ProductVendorsControllerTests : ControllerTests
    {
        private ProductVendorsController controller;
        private IProductVendorValidator validator;
        private IProductVendorService service;
        private ProductVendorView vendor;

        public ProductVendorsControllerTests()
        {
            validator = Substitute.For<IProductVendorValidator>();
            service = Substitute.For<IProductVendorService>();

            vendor = ObjectsFactory.CreateProductVendorView();

            controller = Substitute.ForPartsOf<ProductVendorsController>(validator, service);
        ...
        {
            service.GetViews().Returns(Array.Empty<ProductVendorView>().AsQueryable());
        ...
        {
            service.Get<ProductVendorView>(vendor.Id).Returns(vendor);
